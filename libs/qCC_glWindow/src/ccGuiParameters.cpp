...
void ccGui::ReleaseInstance() { s_gui.release(); }
...
ccGui::ParamStruct::ParamStruct() { reset(); }
...
void ccGui::ParamStruct::fromPersistentSettings() {
  ...
  lightAmbientColor = ccColor::Rgbaf(reinterpret_cast<float *>(
      settings
          .value("lightAmbientColor",
                 QByteArray::fromRawData((const char *)ccColor::darkest.rgba,
                                         c_fColorArraySize))
          .toByteArray()
          .data()));
  lightSpecularColor = ccColor::Rgbaf(reinterpret_cast<float *>(
      settings
          .value("lightSpecularColor",
                 QByteArray::fromRawData((const char *)ccColor::darker.rgba,
                                         c_fColorArraySize))
          .toByteArray()
          .data()));
  lightDiffuseColor = ccColor::Rgbaf(reinterpret_cast<float *>(
      settings
          .value("lightDiffuseColor",
                 QByteArray::fromRawData((const char *)ccColor::bright.rgba,
                                         c_fColorArraySize))
          .toByteArray()
          .data()));
  meshFrontDiff = ccColor::Rgbaf(reinterpret_cast<float *>(
      settings
          .value("meshFrontDiff",
                 QByteArray::fromRawData(
                     (const char *)ccColor::defaultMeshFrontDiff.rgba,
                     c_fColorArraySize))
          .toByteArray()
          .data()));
  meshBackDiff = ccColor::Rgbaf(reinterpret_cast<float *>(
      settings
          .value("meshBackDiff",
                 QByteArray::fromRawData(
                     (const char *)ccColor::defaultMeshBackDiff.rgba,
                     c_fColorArraySize))
          .toByteArray()
          .data()));
  meshSpecular = ccColor::Rgbaf(reinterpret_cast<float *>(
      settings
          .value("meshSpecular",
                 QByteArray::fromRawData((const char *)ccColor::middle.rgba,
                                         c_fColorArraySize))
          .toByteArray()
          .data()));
  pointsDefaultCol = ccColor::Rgbaub(reinterpret_cast<unsigned char *>(
      settings
          .value(
              "pointsDefaultRGBAColor",
              QByteArray::fromRawData((const char *)ccColor::defaultColor.rgba,
                                      c_ub4ColorArraySize))
          .toByteArray()
          .data()));
  textDefaultCol = ccColor::Rgbaub(reinterpret_cast<unsigned char *>(
      settings
          .value(
              "textDefaultRGBAColor",
              QByteArray::fromRawData((const char *)ccColor::defaultColor.rgba,
                                      c_ub4ColorArraySize))
          .toByteArray()
          .data()));
  backgroundCol = ccColor::Rgbaub(reinterpret_cast<unsigned char *>(
      settings
          .value("backgroundColor",
                 QByteArray::fromRawData(
                     (const char *)ccColor::defaultBkgColor.rgb,
                     c_ub3ColorArraySize))
          .toByteArray()
          .data()));
  labelBackgroundCol = ccColor::Rgbaub(reinterpret_cast<unsigned char *>(
      settings
          .value("labelBackgroundRGBAColor",
                 QByteArray::fromRawData(
                     (const char *)ccColor::defaultLabelBkgColor.rgba,
                     c_ub4ColorArraySize))
          .toByteArray()
          .data()));
  labelMarkerCol = ccColor::Rgbaub(reinterpret_cast<unsigned char *>(
      settings
          .value("labelMarkerRGBAColor",
                 QByteArray::fromRawData(
                     (const char *)ccColor::defaultLabelMarkerColor.rgba,
                     c_ub4ColorArraySize))
          .toByteArray()
          .data()));
  bbDefaultCol = ccColor::Rgbaub(reinterpret_cast<unsigned char *>(
      settings
          .value("bbDefaultRGBAColor",
                 QByteArray::fromRawData((const char *)ccColor::yellow.rgba,
                                         c_ub4ColorArraySize))
          .toByteArray()
          .data()));
  ...
  pickingCursorShape = static_cast<Qt::CursorShape>(
      settings.value("cursorShape", static_cast<int>(Qt::CrossCursor)).toInt());
  logVerbosityLevel = static_cast<ccLog::MessageLevelFlags>(
      settings.value("logVerbosityLevel", static_cast<int>(ccLog::LOG_STANDARD))
          .toInt());
...
void ccGui::ParamStruct::toPersistentSettings() const {
  ...
  settings.setValue(
      "lightSpecularColor",
      QByteArray((const char *)lightSpecularColor.rgba, c_fColorArraySize));
  settings.setValue(
      "meshFrontDiff",
  ...
  settings.setValue(
      "pointsDefaultRGBAColor",
      QByteArray((const char *)pointsDefaultCol.rgba, c_ub4ColorArraySize));
  settings.setValue(
      "textDefaultRGBAColor",
      QByteArray((const char *)textDefaultCol.rgba, c_ub4ColorArraySize));
  settings.setValue(
      "backgroundColor",
      QByteArray((const char *)backgroundCol.rgb, c_ub3ColorArraySize));
  settings.setValue(
      "labelBackgroundRGBAColor",
      QByteArray((const char *)labelBackgroundCol.rgba, c_ub4ColorArraySize));
  settings.setValue(
      "labelMarkerRGBAColor",
      QByteArray((const char *)labelMarkerCol.rgba, c_ub4ColorArraySize));
  settings.setValue(
      "bbDefaultRGBAColor",
      QByteArray((const char *)bbDefaultCol.rgba, c_ub4ColorArraySize));
