...
ccCylinder::ccCylinder(
    PointCoordinateType radius, PointCoordinateType height,
...
ccGenericPrimitive *ccCylinder::clone() const {
  return finishCloneJob(new ccCylinder(
      m_bottomRadius, m_height, &m_transformation, getName(), m_drawPrecision));
}
