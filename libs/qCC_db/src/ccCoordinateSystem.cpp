...
ccCoordinateSystem::ccCoordinateSystem(
    PointCoordinateType displayScale, PointCoordinateType axisWidth,
    const ccGLMatrix *transMat /*=nullptr*/,
    QString name /*=QString("CoordinateSystem")*/)
    : ccGenericPrimitive(name, transMat), m_DisplayScale(displayScale),
      m_width(axisWidth), m_showAxisPlanes(true), m_showAxisLines(true) {
...
ccCoordinateSystem::ccCoordinateSystem(
    const ccGLMatrix *transMat /*=nullptr*/,
    QString name /*=QString("CoordinateSystem")*/)
    : ccGenericPrimitive(name, transMat), m_DisplayScale(DEFAULT_DISPLAY_SCALE),
      m_width(AXIS_DEFAULT_WIDTH), m_showAxisPlanes(true),
...
ccCoordinateSystem::ccCoordinateSystem(
    QString name /*=QString("CoordinateSystem")*/)
    : ccGenericPrimitive(name), m_DisplayScale(DEFAULT_DISPLAY_SCALE),
      m_width(AXIS_DEFAULT_WIDTH), m_showAxisPlanes(true),
      m_showAxisLines(true) {
  updateRepresentation();
  showColors(true);
...
bool ccCoordinateSystem::fromFile_MeOnly(QFile &in, short dataVersion,
                                         int flags,
  ...
  ccSerializationHelper::CoordsFromDataStream(inStream, flags, &m_DisplayScale,
                                              1);
