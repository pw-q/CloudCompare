...
ccRenderToFileDlg::ccRenderToFileDlg(unsigned baseWidth, unsigned baseHeight,
                                     QWidget *parent /*=nullptr*/)
    : QDialog(parent), w(baseWidth), h(baseHeight),
  ...
  QString currentPath =
      settings
          .value("currentPath", QStandardPaths::writableLocation(
  ...
  connect(m_ui->chooseFileButton, &QToolButton::clicked, this,
          &ccRenderToFileDlg::chooseFile);
  connect(m_ui->buttonBox, &QDialogButtonBox::accepted, this,
          &ccRenderToFileDlg::saveSettings);
  connect(m_ui->zoomDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccRenderToFileDlg::updateInfo);
