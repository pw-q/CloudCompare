...
ccStatisticalTestDlg::ccStatisticalTestDlg(QString p1Label, QString p2Label,
                                           QString p3Label /*=QString()*/,
                                           QString windowTitle /*=QString()*/,
                                           QWidget *parent /*=nullptr*/)
    : QDialog(parent, Qt::Tool), m_ui(new Ui::StatisticalTestDialog) {
  m_ui->setupUi(this);
...
ccStatisticalTestDlg::~ccStatisticalTestDlg() { delete m_ui; }
