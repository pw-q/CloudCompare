...
public:
  DipDirTransformationDialog(QWidget *parent = nullptr) : QDialog(parent) {
    setupUi(this);
  }
};
...
ccApplyTransformationDlg::ccApplyTransformationDlg(QWidget *parent /*=nullptr*/)
  ...
  // Axis and angle
  connect(rxAxisDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onRotAngleValueChanged);
  connect(ryAxisDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onRotAngleValueChanged);
  connect(rzAxisDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onRotAngleValueChanged);
  connect(rAngleDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onRotAngleValueChanged);
  connect(txAxisDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onRotAngleValueChanged);
  connect(tyAxisDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onRotAngleValueChanged);
  connect(tzAxisDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onRotAngleValueChanged);
  connect(scaleDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onRotAngleValueChanged);
  connect(setIAxisToolButton, &QToolButton::clicked, [this] {
    rxAxisDoubleSpinBox->setValue(1.0);
    ryAxisDoubleSpinBox->setValue(0.0);
    rzAxisDoubleSpinBox->setValue(0.0);
  });
  connect(setJAxisToolButton, &QToolButton::clicked, [this] {
    rxAxisDoubleSpinBox->setValue(0.0);
    ryAxisDoubleSpinBox->setValue(1.0);
    rzAxisDoubleSpinBox->setValue(0.0);
  });
  connect(setKAxisToolButton, &QToolButton::clicked, [this] {
    rxAxisDoubleSpinBox->setValue(0.0);
    ryAxisDoubleSpinBox->setValue(0.0);
    rzAxisDoubleSpinBox->setValue(1.0);
  });
  connect(pasteAxisToolButton, &QToolButton::clicked, this,
          &ccApplyTransformationDlg::axisFromClipboard);
  connect(pasteTransToolButton, &QToolButton::clicked, this,
          &ccApplyTransformationDlg::transFromClipboard);

  // Euler angles
  connect(ePhiDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onEulerValueChanged);
  connect(eThetaDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onEulerValueChanged);
  connect(ePsiDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onEulerValueChanged);
  ...
  connect(etzAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onEulerValueChanged);
  connect(eScaleDoubleSpinBox, qOverload<double>(&QDoubleSpinBox::valueChanged),
          this, &ccApplyTransformationDlg::onEulerValueChanged);
  connect(pasteEulerAnglesToolButton, &QToolButton::clicked, this,
          &ccApplyTransformationDlg::eulerAnglesFromClipboard);
  connect(pasteEulerTransToolButton, &QToolButton::clicked, this,
          &ccApplyTransformationDlg::eulerTransFromClipboard);

  // From-->to axes
  connect(fromXAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(fromYAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(fromZAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(toXAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(toYAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(toZAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(fromToTxAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(fromToTyAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(fromToTzAxisDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(fromToScaleDoubleSpinBox,
          qOverload<double>(&QDoubleSpinBox::valueChanged), this,
          &ccApplyTransformationDlg::onFromToValueChanged);
  connect(pasteFromAxisToolButton, &QToolButton::clicked, this,
          &ccApplyTransformationDlg::fromAxisFromClipboard);
  connect(pasteToAxisToolButton, &QToolButton::clicked, this,
          &ccApplyTransformationDlg::toAxisFromClipboard);
  connect(pasteFromToTransToolButton, &QToolButton::clicked, this,
          &ccApplyTransformationDlg::fromToTransFromClipboard);

  connect(setFromAxisIToolButton, &QToolButton::clicked, [this] {
    fromXAxisDoubleSpinBox->setValue(1.0);
    fromYAxisDoubleSpinBox->setValue(0.0);
    fromZAxisDoubleSpinBox->setValue(0.0);
  });
  connect(setFromAxisJToolButton, &QToolButton::clicked, [this] {
    fromXAxisDoubleSpinBox->setValue(0.0);
    fromYAxisDoubleSpinBox->setValue(1.0);
    fromZAxisDoubleSpinBox->setValue(0.0);
  });
  connect(setFromAxisKToolButton, &QToolButton::clicked, [this] {
    fromXAxisDoubleSpinBox->setValue(0.0);
    fromYAxisDoubleSpinBox->setValue(0.0);
    fromZAxisDoubleSpinBox->setValue(1.0);
  });

  connect(setToAxisIToolButton, &QToolButton::clicked, [this] {
    toXAxisDoubleSpinBox->setValue(1.0);
    toYAxisDoubleSpinBox->setValue(0.0);
    toZAxisDoubleSpinBox->setValue(0.0);
  });
  connect(setToAxisJToolButton, &QToolButton::clicked, [this] {
    toXAxisDoubleSpinBox->setValue(0.0);
    toYAxisDoubleSpinBox->setValue(1.0);
    toZAxisDoubleSpinBox->setValue(0.0);
  });
  connect(setToAxisKToolButton, &QToolButton::clicked, [this] {
    toXAxisDoubleSpinBox->setValue(0.0);
    toYAxisDoubleSpinBox->setValue(0.0);
    toZAxisDoubleSpinBox->setValue(1.0);
  });
}
...
void ccApplyTransformationDlg::onMatrixTextChange() {
  ...
  if (valid) {
    updateAll(mat, false, true, true,
              true); // no need to update the current form
  }
}
...
ccGLMatrixd
ccApplyTransformationDlg::getTransformation(bool &applyToGlobal) const {
...
void ccApplyTransformationDlg::initFromDipAndDipDir() {
  ...
  CCVector3d Nd =
      ccNormalVectors::ConvertDipAndDipDirToNormal(s_dip_deg, s_dipDir_deg);
  // corresponding rotation (assuming we start from (0, 0, 1))

  ccGLMatrixd trans =
      ccGLMatrixd::FromToRotation(CCVector3d(0.0, 0.0, 1.0), Nd);
