...
void BundlerImportDlg::initFromPersistentSettings() {
  ...
  bool orthoRectifyAsCloud =
      settings
          .value("orthoRectifyAsClouds",
                 orthoRectifyAsCloudCheckBox->isChecked())
          .toBool();
  bool orthoRectifyAsImage =
      settings
          .value("orthoRectifyAsImages",
                 orthoRectifyAsImageCheckBox->isChecked())
          .toBool();
  bool undistortImages =
      settings.value("undistortImages", undistortImagesCheckBox->isChecked())
          .toBool();
  bool generateColoredDTM =
      settings
          .value("generateColoredDTM", generateColoredDTMGroupBox->isChecked())
          .toBool();
  bool keepImagesInMemory =
      settings
          .value("keepImagesInMemory", keepImagesInMemoryCheckBox->isChecked())
          .toBool();
  bool importImages =
      settings.value("importImages", imagesGroupBox->isChecked()).toBool();
  ...
  bool importKeypoints =
      settings.value("importKeypoints", importKeypointsGroupBox->isChecked())
          .toBool();
  int dtmVerticesCount =
      settings.value("dtmVerticesCount", dtmVerticesSpinBox->value()).toInt();
  int orthoRectMethod =
      settings.value("orthoRectMethod", orthoRectMethodComboBox->currentIndex())
          .toInt();
...
bool BundlerImportDlg::undistortImages() const {
  return imagesGroupBox->isEnabled() && undistortImagesCheckBox->isEnabled() &&
